...
Если $A$ и $B$ --- множества в универсуме $U$, то $A$ является подмножеством (нестрогое включение) $B$ тогда и только тогда когда $overline(A) union B = U.$
#pagebreak()
...
- Пишите аккуратно, *разборчивым почерком*. Если ваш почерк будет больше похож на шифр, проверяющие оставляют за собой право *обнулить* результаты ваших стараний в связи с невозможностью их проверки. 
